...
let firstFilmRating = prompt("На сколько оцените его?")
personalMovieDB["movies"][firstFilmName] = firstFilmRating;

let secondFilmName = prompt("Один из последних просмотренных фильмов?")
let secondFilmRating = prompt("На сколько оцените его?")
